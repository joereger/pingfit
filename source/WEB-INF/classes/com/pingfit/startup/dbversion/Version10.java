 ...
 * Time: 11:57:46 AM
 */
public class Version10 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count3 = Db.RunSQLUpdate("UPDATE exerciselist SET issystemdefault=false");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count3d = Db.RunSQLUpdate("UPDATE exerciselist SET issystemdefault=true where exerciselistid='1'");
        //-----------------------------------
        //-----------------------------------
