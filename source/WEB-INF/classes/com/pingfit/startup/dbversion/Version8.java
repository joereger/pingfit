 ...
 * Time: 11:57:46 AM
 */
public class Version8 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE user DROP lastexerciseid");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count3 = Db.RunSQLUpdate("UPDATE user SET lastexerciseplaceinlist=''");
        //-----------------------------------
        //-----------------------------------
