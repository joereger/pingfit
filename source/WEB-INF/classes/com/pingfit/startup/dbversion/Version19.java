...
public class Version19 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int countf = Db.RunSQLUpdate("UPDATE pl SET airlogo=''");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countfs = Db.RunSQLUpdate("UPDATE pl SET airbgcolor=''");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countfss = Db.RunSQLUpdate("UPDATE pl SET isdefault=false");
        //-----------------------------------
        //-----------------------------------
