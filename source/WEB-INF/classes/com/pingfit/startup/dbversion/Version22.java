 ...
 * Time: 11:57:46 AM
 */
public class Version22 implements UpgradeDatabaseOneVersion {
...
//        //-----------------------------------
//        //-----------------------------------
//        String[][] rstData= Db.RunSQL("SELECT userid FROM user");
//        //-----------------------------------
//        //-----------------------------------
...
//                //-----------------------------------
//                //-----------------------------------
//                int count = Db.RunSQLUpdate("UPDATE user SET pingfitsecret='"+RandomString.randomAlphanumeric(15)+"' WHERE userid='"+rstData[i][0]+"'");
//                //-----------------------------------
//                //-----------------------------------
//            }
//        }
