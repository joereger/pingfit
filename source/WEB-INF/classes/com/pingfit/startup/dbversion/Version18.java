 ...
 * Time: 11:57:46 AM
 */
public class Version18 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int countf = Db.RunSQLUpdate("UPDATE eula SET plid='1'");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countp = Db.RunSQLUpdate("UPDATE user SET plid='1'");
        //-----------------------------------
        //-----------------------------------
