 ...
 * Time: 12:25:50 PM
 */
public class TwitterNewDirectMessage implements Runnable {

    private static ThreadPool tp;
    private String message = "";
    private String usertosendto = "";

    public TwitterNewDirectMessage(String usertosendto, String message){
    ...
    public void run(){
        ...
        logger.debug("user="+usertosendto);
        post.addParameter("user", usertosendto);
        post.addParameter("text", Str.truncateString(message, 140));
